...
const transformData = (id, patientData) => {
  ...
  const transformItem = (data) => {
    ...
    const order = ['nombre', 'apellido', 'email', 'usuario', 'nacimiento', 'edad', 'pref', 'tel', 'saldo', 'genero', 'coberura', 'id'];
...
const transformedData = transformData(1, datosPacientes);
...
const Paciente = ({ id }) => {
  ...
  const data = transformData(id, datosPacientes);
console.log(data)
  return (
    <Descriptions
